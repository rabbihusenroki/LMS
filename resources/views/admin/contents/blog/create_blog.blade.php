          ...
          <div class="card">
            ...
            <form action="{{route('store.blog')}}" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group mb-3">
                    <label for="exampleInputText" class="form-label">Blog Description</label>
                    <textarea name="blog_description" class="form-control" id="exampleInputText" cols="30" rows="3"></textarea>
                    @error('blog_description')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                  </div>
                  <div class="form-group mb-3">
                    <label for="exampleFormControlFile1">Please input Blog Post image</label>
